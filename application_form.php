	...
	<header>
		<div class="container agile-banner_nav">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<h1><a class="navbar-brand" href="home.php">CUET <span class="display"></span></a></h1>
				...
				<div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item active">
							<a class="nav-link" href="services.php">Halls</a>
						</li>
						<li class="nav-item">
				...
				<form action="application_form.php?id=<?php echo $_GET['id']?>" method="post">
					<div class="row">
						<div class="col-md-6 contact_left_grid" data-aos="fade-right">
							...
							<div class="contact-fields-w3ls">
								<input type="text" name="Hostel_man_id" placeholder="Hostel Manager ID" required="">
							</div>
							<div class="contact-fields-w3ls">
   ...
   if(isset($_POST['submit'])){
     ...
     if($row = mysqli_fetch_assoc($result)){
        ...
        if($pwdCheck == false){
            ...
            $query3 = "INSERT INTO Application (Student_id,Hostel_id,Hostel_man_id,Application_status,Room_no,Message) VALUES ('$roll','$hostel_id','$hostel_man_id',true,'$rom_no','$message')";
