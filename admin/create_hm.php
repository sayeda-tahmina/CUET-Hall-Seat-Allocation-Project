	...
	<header>
		<div class="container agile-banner_nav">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<h1><a class="navbar-brand" href="admin_home.php">CUET <span class="display"></span></a></h1>
				...
				<div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item">
							<a class="nav-link" href="create_hm.php">Appoint Hall Manager</a>
						</li>
						<li class="nav-item">
...
<br><br><br><br><br>
	<div class="main">
        ...
        <fieldset class="step w3_agileits">
          <legend>Appoint Hall Manager</legend>
            <div class="agilecontactw3ls-grid">
              <div class="agile-con-centre">
                <form action="../includes/hm_signup.php" method="POST">
                  ...
                  <input type="text" name="hostel_name" placeholder="HALL NAME" required="required">
                  <input type="email" name="Email" placeholder="EMAIL" required="required">
                  <input type="password" name="pass" placeholder="HALL MANAGER'S PASSWORD" required="required">
                  <input type="password" name="confpass" placeholder="CONFIRM HALL MANAGER'S PASSWORD" required="required">
              ...
              <div class="clear"></div>
				...
				<fieldset class="step w3_agileits">
          <legend>Remove Hall Manager</legend>
            <div class="agilecontactw3ls-grid">
              <div class="agile-con-centre">
