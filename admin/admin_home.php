...
<header>
	<div class="container agile-banner_nav">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
          ...
          <li class="nav-item">
						<a class="nav-link" href="create_hm.php">Appoint/Remove Hall Manager</a>
					</li>
				...
				<li class="visible">
					<div class="svg-wrapper">
						<svg viewBox="0 0 1400 800">
							...
							<image height='800px' width="1400px" clip-path="url(#cd-image-1)" xlink:href="../web_home/images/gate.jpg"></image>
						</svg>
					</div> <!-- .svg-wrapper -->
					<div class="cd-radial-slider-content">
						<div class="wrapper">
							<div class="text-center">
								<h2>Hall Seat Allocation </h2>
								<h3> System </h3>
				...
				<li class="next-slide">
					<div class="svg-wrapper">
						<svg viewBox="0 0 1400 800">
							...
							<image height='800px' width="1400px" clip-path="url(#cd-image-2)" xlink:href="../web_home/images/hall.jpg"></image>
						</svg>
					</div> <!-- .svg-wrapper -->
